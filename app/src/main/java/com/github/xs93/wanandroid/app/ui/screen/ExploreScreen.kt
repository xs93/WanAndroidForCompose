...
import com.github.xs93.wanandroid.app.ui.widget.ClassSwipeRefreshHeader
import com.github.xs93.wanandroid.app.ui.widget.SwipeRefreshLayout
import com.github.xs93.wanandroid.app.ui.widget.SwipeRefreshStyle
...
fun ExploreScreen(viewModel: ExploreViewModel = viewModel()) {
    ...
    LifecycleResumeEffect(key1 = firstInit) {
        if (firstInit) {
            firstInit = false
            scope.launch {
                delay(1000L)
    ...
    SwipeRefreshLayout(modifier = Modifier.fillMaxSize(),
        ...
        indicator = {
            ClassSwipeRefreshHeader(
                flag = uiState.swipeRefreshState.refreshStateFlag,
